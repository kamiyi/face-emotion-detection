...
image_path = r"C:\Users\rezak\Desktop\\20250123_121952.jpg"
image = cv2.imread(image_path)

detector = MTCNN()
faces = detector.detect_faces(image)
emotion_model = load_model(r'J:\course\cs50p\x\cs50x-finalproject-face-emotion-detection\\model_v6_23.hdf5')
emotion_labels = {'Angry': 0, 'Sad': 5, 'Neutral':4, 'Disgust': 1, 'Surprise': 6, 'Fear': 2, 'Happy': 3}
colors = [(255,0,0), (0,100,0), (0,255,0), (0,0,255), (255,0,255), (255,69,0), (139,0,139)]
